...
export class Home extends Component {
  ...
  render () {
    return (
      <div>
        <h1>HELLO, Google !</h1>
        <p>Welcome to new single-page application, built with:</p>
        <ul>
        ...
        <p>The <code>ClientApp</code> subdirectory is a standard React application based on the <code>create-react-app</code> template. Open a command prompt in that directory, you can run <code>npm</code> commands such as <code>npm test</code> or <code>npm install</code>.</p>
      </div>
    );
  }
}
